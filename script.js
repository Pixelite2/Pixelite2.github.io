...
const lottotime = (event) => {
    ...
    let v9 = parseInt(document.getElementById('v9').value) * 10 || 0;
    ...
    let v13 = parseInt(document.getElementById('v13').value) * 5 || 0;
    ...
    let v18 = parseInt(document.getElementById('v18').value) * 2 || 0;
